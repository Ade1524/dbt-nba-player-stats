...
-- Seasons 97-22 player stats columns          
          ...
          ,r.year_of_birth as regular_season_stats_year_of_birth
          ,r.position as regular_season_stats_position
          ,r.age as regular_season_stats_age
          ,r.teams as regular_season_stats_teams
          ,r.team_name as regular_season_stats_team_name
          ,r.games as regular_season_stats_games
          ,r.games_started as regular_season_stats_games_started
          ,r.minutes_played_per_game as regular_season_stats_minutes_played_per_game
          ,r.field_goals_per_game as regular_season_stats_field_goals_per_game
          ,r.field_goal_attempts_per_game as regular_season_stats_field_goal_attempts_per_game
          ,r.field_goal_percentage as regular_season_stats_field_goal_percentage
          ,r.c_3_point_field_goals_per_game as regular_season_stats_c_3_point_field_goals_per_game
          ,r.c_3_point_field_goal_attempts_per_game as regular_season_stats_c_3_point_field_goal_attempts_per_game
          ,r.c_3_point_field_goal_percentage as regular_season_stats_c_3_point_field_goal_percentage
          ,r.c_2_point_field_goals_per_game as regular_season_stats_c_2_point_field_goals_per_game
          ,r.c_2_point_field_goal_attempts_per_game as regular_season_stats_c_2_point_field_goal_attempts_per_game
          ,r.c_2_point_field_goal_percentage as regular_season_stats_c_2_point_field_goal_percentage
          ,r.effective_field_goal_percentage as regular_season_stats_effective_field_goal_percentage
          ,r.free_throws_per_game as regular_season_stats_free_throws_per_game
          ,r.free_throw_attempts_per_game as regular_season_stats_free_throw_attempts_per_game
          ,r.free_throw_percentage as regular_season_stats_free_throw_percentage
          ,r.offensive_rebounds_per_game as regular_season_stats_offensive_rebounds_per_game
          ,r.defensive_rebounds_per_game as regular_season_stats_defensive_rebounds_per_game
          ,r.total_rebounds_per_game as regular_season_stats_total_rebounds_per_game
          ,r.assists_per_game as regular_season_stats_assists_per_game
          ,r.steals_per_game as regular_season_stats_steals_per_game
          ,r.blocks_per_game as regular_season_stats_blocks_per_game
          ...
          ,(substring(frs.seasons, 1, 4)::number - substring(ro.seasons, 1, 4)::number) + row_number() over (partition by r.player_id order by r.seasons) as num_of_seasons_in_league
...
-- Playoffs player stats columns           
          ...
          ,p.teams as playoffs_stats_teams
